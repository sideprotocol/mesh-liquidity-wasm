...
sidechaind tx ibc-swap make channel-3 100aside side1lqd386kze5355mgpncu5y52jcdhs85ckj7kdv0 100stake --from $KEY --keyring-backend test --chain-id $CHAIN_ID --gas-prices 0.01aside --gas auto --gas-adjustment 1.2 --trace